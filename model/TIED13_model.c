 ...
 * static_model.c
 *
 * automatically generated from TIED13.iid
 */
#include "TIED13_model.h"
...
extern DataSetEntry iedModelds_PROT_LLN0_Alarm_fcda5;
...
DataSetEntry iedModelds_PROT_LLN0_Alarm_fcda4 = {
  "PROT",
  false,
  "SIML$ST$GasFlwTr$stVal",
  -1,
  NULL,
  NULL,
  &iedModelds_PROT_LLN0_Alarm_fcda5
};

DataSetEntry iedModelds_PROT_LLN0_Alarm_fcda5 = {
  "PROT",
  false,
...
extern DataSetEntry iedModelds_MEAS_LLN0_Meas_fcda10;
...
DataSetEntry iedModelds_MEAS_LLN0_Meas_fcda9 = {
  ...
  NULL,
  NULL,
  &iedModelds_MEAS_LLN0_Meas_fcda10
};

DataSetEntry iedModelds_MEAS_LLN0_Meas_fcda10 = {
  "MEAS",
  false,
  "YLTC$MX$TapPos$valWithTrans$posVal",
  -1,
  NULL,
  NULL,
  NULL
...
LogicalNode iedModel_PROT_YPTR = {
    LogicalNodeModelType,
    "YPTR",
    (ModelNode*) &iedModel_PROT,
    (ModelNode*) &iedModel_PROT_SIML,
    (ModelNode*) &iedModel_PROT_YPTR_HPTmpTr,
};

DataObject iedModel_PROT_YPTR_HPTmpTr = {
    DataObjectModelType,
    "HPTmpTr",
    (ModelNode*) &iedModel_PROT_YPTR,
    NULL,
    (ModelNode*) &iedModel_PROT_YPTR_HPTmpTr_stVal,
    0
};

DataAttribute iedModel_PROT_YPTR_HPTmpTr_stVal = {
    DataAttributeModelType,
    "stVal",
    (ModelNode*) &iedModel_PROT_YPTR_HPTmpTr,
    NULL,
...
LogicalNode iedModel_PROT_SIML = {
    LogicalNodeModelType,
    "SIML",
    (ModelNode*) &iedModel_PROT,
    NULL,
    (ModelNode*) &iedModel_PROT_SIML_GasInsTr,
};

DataObject iedModel_PROT_SIML_GasInsTr = {
    DataObjectModelType,
    "GasInsTr",
    (ModelNode*) &iedModel_PROT_SIML,
    (ModelNode*) &iedModel_PROT_SIML_GasFlwTr,
    (ModelNode*) &iedModel_PROT_SIML_GasInsTr_stVal,
    0
};

DataAttribute iedModel_PROT_SIML_GasInsTr_stVal = {
    DataAttributeModelType,
    "stVal",
    (ModelNode*) &iedModel_PROT_SIML_GasInsTr,
    NULL,
...
DataObject iedModel_PROT_SIML_GasFlwTr = {
    DataObjectModelType,
    "GasFlwTr",
    (ModelNode*) &iedModel_PROT_SIML,
    NULL,
    (ModelNode*) &iedModel_PROT_SIML_GasFlwTr_stVal,
    0
};

DataAttribute iedModel_PROT_SIML_GasFlwTr_stVal = {
    DataAttributeModelType,
    "stVal",
    (ModelNode*) &iedModel_PROT_SIML_GasFlwTr,
    NULL,
...
LogicalNode iedModel_MEAS_YLTC = {
    LogicalNodeModelType,
    "YLTC",
    (ModelNode*) &iedModel_MEAS,
    NULL,
    (ModelNode*) &iedModel_MEAS_YLTC_TapPos,
};

DataObject iedModel_MEAS_YLTC_TapPos = {
    DataObjectModelType,
    "TapPos",
    (ModelNode*) &iedModel_MEAS_YLTC,
    NULL,
    (ModelNode*) &iedModel_MEAS_YLTC_TapPos_valWithTrans,
    0
};

DataAttribute iedModel_MEAS_YLTC_TapPos_valWithTrans = {
    DataAttributeModelType,
    "valWithTrans",
    (ModelNode*) &iedModel_MEAS_YLTC_TapPos,
    NULL,
    (ModelNode*) &iedModel_MEAS_YLTC_TapPos_valWithTrans_posVal,
    0,
    IEC61850_FC_MX,
    IEC61850_CONSTRUCTED,
    0,
...
DataAttribute iedModel_MEAS_YLTC_TapPos_valWithTrans_posVal = {
    DataAttributeModelType,
    "posVal",
    (ModelNode*) &iedModel_MEAS_YLTC_TapPos_valWithTrans,
    NULL,
...
GSEControlBlock iedModel_CTRL_LLN0_gse0 = {&iedModel_CTRL_LLN0, "Status", "TIED13/CTRL/LLN0/Status", "Status", 10002, false, NULL, -1, -1, &iedModel_PROT_LLN0_gse0};
GSEControlBlock iedModel_PROT_LLN0_gse0 = {&iedModel_PROT_LLN0, "Alarm", "TIED13/PROT/LLN0/Alarm", "Alarm", 10002, false, NULL, -1, -1, &iedModel_MEAS_LLN0_gse0};
GSEControlBlock iedModel_MEAS_LLN0_gse0 = {&iedModel_MEAS_LLN0, "Meas", "TIED13/MEAS/LLN0/Meas", "Meas", 10002, false, NULL, -1, -1, NULL};
